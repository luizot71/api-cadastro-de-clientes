...
public class FormCliente {
	...
	private FormEndereco endereco = new FormEndereco();

	public FormCliente(@NotEmpty @Length(min = 3) String nome, @NotEmpty String cpf, LocalDate dataNascimento, Genero genero, FormEndereco endereco) {
		this.nome = nome;
		this.cpf = cpf;
