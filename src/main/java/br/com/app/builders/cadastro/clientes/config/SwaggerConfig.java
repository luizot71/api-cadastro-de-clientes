package br.com.app.builders.cadastro.clientes.config;
...
public class SwaggerConfig {
    ...
    private static ApiInfo apiInfo() {
        return new ApiInfo("Api Cadastro de Clientes", "Esta Api foi criada com recursos para Cadastro de Clientes.\n",
    ...
    public Docket docket(){
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apis(RequestHandlerSelectors
                        .basePackage("br.com.app.builders.cadastro.clientes.rest.controller"))
